...
tf.flags.DEFINE_string("image_dir",
                       "/home/leon/ML/AI_Challenger/Image_Caption/ai_challenger_caption_train_20170902/caption_train_images_20170902",
                       "image directory.")
tf.flags.DEFINE_string("captions_file",
                       "/home/leon/ML/AI_Challenger/Image_Caption/ai_challenger_caption_train_20170902/caption_train_annotations_20170902.json",
                       "captions json file.")

tf.flags.DEFINE_string("output_dir",
                       "/home/leon/ML/AI_Challenger/Image_Caption/ai_challenger_caption_train_output",
...
def _process_dataset(name, images, vocab, num_shards):
    ...
    spacing = np.linspace(0, len(images), num_threads + 1).astype("int")
    ranges = []
    threads = []
...
# 输出的是[namedtuple(ImageMetaData, [id, filename, captions(分好词且加入词头词尾)])]
...
def main(unused_argv):
    ...
    train_captions = [c for image in train_dataset for c in image.captions] # 取出所有图片的所有captions(分好词)
